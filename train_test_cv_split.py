...
test_file_name = "/subsets/test_set.csv" 
...
train_file_name = "/subsets/train_set.csv" 
...
for l in range(5):
    ...
    train_cv_file_name = "/subsets/train_cv_set"+ str(l)+".csv"
    test_cv_file_name = "/subsets/test_cv_set"+ str(l)+".csv"
