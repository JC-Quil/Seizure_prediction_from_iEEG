### model_cv.py implementation for the 2nd model ###
...
# Initiate the dictionary containing the list of best values for the parameter
best_param_set = {
 'max_depth': 6,
 'learning_rate': 0.1,
 'n_estimators': 100,
...
def xgb_model_cv(param_set):
	...
	for i in range(5):
		...
		train_df = pd.read_csv("/subsets/train_cv_set2"+str(i)+".csv")
		test_df = pd.read_csv("/subsets/test_cv_set2"+str(i)+".csv")
...
file_name = "cv_optimization_Model2.csv"
