### train_test_cv_split implementation for the project 3rd model ###
### Split the labelled dataset between train and test set, and create a 5-Fold cross validation split for the 3rd model ###
...
functions_7 = ['shannon entropy', 'PSD wavelet']
functions_1 = ['mean', 'std dev', 'hjorth activity', 'hjorth mobility', 'hjorth complexity', 'skewness', 'kurtosis', 'Katz FD', 'Higuchi FD']
...
test_file_name = "/subsets/test_set3.csv" 
...
train_file_name = "/subsets/train_set3.csv" 
...
for l in range(5):
    ...
    train_cv_file_name = "/subsets/train_cv_set3"+ str(l)+".csv"
    test_cv_file_name = "/subsets/test_cv_set3"+ str(l)+".csv"
