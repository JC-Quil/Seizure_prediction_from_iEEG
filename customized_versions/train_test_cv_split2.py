### train_test_cv_split.py implementation for the project 2nd model ###
### Split the labelled dataset between train and test set, and create a 5-Fold cross validation split for the 2nd model ###
...
functions_1 = ['spectral edge frequency']
functions_7 = ['shannon entropy', 'power spectral density', 'correlation matrix (frequency)']
...
test_file_name = "subsets/test_set2.csv" 
...
train_file_name = "subsets/train_set2.csv" 
...
for l in range(5):
    ...
    train_cv_file_name = "subsets/train_cv_set2"+ str(l)+".csv"
    test_cv_file_name = "subsets/test_cv_set2"+ str(l)+".csv"
